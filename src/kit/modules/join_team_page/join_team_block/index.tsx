...
const typography = require('../../../../shared/styles/typography.scss')
...
export default function JoinTeamBlock(props: Props) {
    ...
    return (
        <div className={[styles.join_team_block, styles[props.orientation]].join(' ')}>
            ...
            <div className={styles.media_block}>
                ...
                <div className={styles.avatar_block}>
                    ...
                    <div className={styles.name_block}>
                        ...
                        <p className={[typography.text, styles.member_job_position].join(' ')}>{props.teamMember.title}</p>
                    </div>
                </div>
            </div>
        </div>
