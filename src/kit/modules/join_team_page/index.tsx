...
const quote1_avatar = require('../../../shared/images/team_members/aitirgan_zulpukarova_avatar.png');
const quote2_avatar = require('../../../shared/images/join_team-page/Asel.png');
const volonter = require("../../../shared/images/join_team-page/volonter.JPG")
  ...
  return (
    <>
      ...
      <JoinTeamBlock
        ...
        title={t('title2')}
        text={t('info2')}
        buttons={[{ href: 'https://docs.google.com/forms/d/1Ho2GWbf6VZmzlQozS__rxFwx9t8MZNVlGu7PON56kLs/edit'}]}
      ...
      <JoinTeamBlock
        ...
        title={t('title3')}
        text={t('info3')}
        buttons={[{ href: 'https://docs.google.com/forms/d/1O_ahB9QaIZ3YnHV8djIa1q0i1y8AwFcyoA4t1pvUJUk/edit'}]}
