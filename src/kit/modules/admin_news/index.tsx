...
import { TGetNews, TNewsList } from "./TCreateNews";
...
import {
  ...
  useGetNewsQuery,
} from "../../../store/queryReducers/newsApi";
  ...
  return (
    <div>
      ...
      >
        ...
        <p className={[styles.form_header].join("")}>Добавить Новость</p>
        <div
          style={{
            display: "flex",
      ...
      >
        <TableContainer>
          <Table>
            ...
            <TableBody>
              {data &&
                data.list.map((news: any, index: any) => (
                  <TableRow key={index}>
                    ...
                    <TableCell align="left">
                      <Button
                        variant="contained"
                        onClick={() =>
                          history.push(`/admin/edit/news/${news.id}`)
                        }
                      >
                        Edit
                      </Button>
