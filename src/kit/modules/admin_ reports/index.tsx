...
import {
  ...
  useGetReportsQuery,
} from "../../../store/queryReducers/reportsApi";
  ...
  return (
    <div>
      ...
      >
        ...
        <p className={[styles.form_header].join("")}>Добавить Отчет</p>
        <div
          style={{
            display: "flex",
      ...
      >
        <TableContainer>
          <Table>
            ...
            <TableBody>
              {data &&
                data.list.map((report: any, index: number) => (
                  <TableRow key={index}>
                    ...
                    <TableCell align="right">
                      <Button
                        variant="contained"
                        onClick={() =>
                          history.push(`/admin/edit/report/${report.id}`)
                        }
                      >
                        Edit
                      </Button>
