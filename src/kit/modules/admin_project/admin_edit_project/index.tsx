...
import { useUpdateProjectMutation } from "../../../../store/queryReducers/projectsApi";
...
const AdminEditProject: FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    updateProject({ id: params.id, body: formData });
  };
  ...
  return (
    ...
    >
      ...
      <p className={[styles.form_header].join("")}>Редактировать Проект</p>
      <div
        style={{
          display: "flex",
