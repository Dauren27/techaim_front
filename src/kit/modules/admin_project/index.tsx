...
import {createProject, deleteProject, getProject} from "../../../api/axiosApiRequest";
...
export default function AdminOurTeam() {
    ...
    const [data, setData] = useState<TGetProject>();
    ...
    useEffect(() => {
        getProject().then((response) => setData(response.data)).catch((err) => console.log(err));
    }, [])
        ...
        <div>
            ...
            <TableContainer>
                    <Table>
                        ...
                        <TableBody>
                            {data && data.list.map((project, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell
                                        align="left"><Button variant="contained"
                                         onClick={() => history.push(`/admin/edit/project/${project.id}`)}>Edit</Button>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
