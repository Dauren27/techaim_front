...
import {editPartner, getPartnerById} from "../../../../api/axiosApiRequest";
...
const AdminEditTeam: FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        await editPartner(params.id, formData);
    ...
    useEffect(() => {
        getPartnerById(params.id).then((response) => setData(response.data)).catch((err) => console.log(err));
    }, [params.id])
