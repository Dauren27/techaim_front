                    ...
                    <li>
                        <FormControl className={styles.lang_form_control}>
                            ...
                            >
                                ...
                                <option key={'kyr'} value={'kyr'}>KYR</option>
                            </Select>
                        </FormControl>
                    </li>
                    <li>
                        {isUserLoggedIn
                            ? <Button onClick={handleLogOut}  variant="contained" style={{backgroundColor: "orange", marginTop: "20px"}}>
                                {t('Logout')}
                            </Button>
                            : <Button variant="contained" onClick={redirect} style={{backgroundColor: "orange"}}>
                                {t('Login')}
                            </Button>}
                    </li>
                </ul>
